...
{% <hero_element bg="" title="PRODUCTS" subtitle="Make the impossible" slogan="POSSIBLE"> %}
	{% <hero_content
		lang
...
{% <hero_element bg="" title="OUR CUSTOMERS" subtitle="Our mission is to support" slogan="SUSTAINABLE GROWTH"> %}
	{% <hero_content lang img="partners.svg" alt="" link="" link_text=""> %}
